...
export default function LocOBBTopNotificatins(){
    return(
        <>
           <div class="dashboard-box d-none d-md-block">
                ...
                <div class="notif-box-wrapper obb-wrapper2 wrapper-box-scroll custom-scrollbar">
                    ...
                    <div class="notif-inner-bar">
                      <div class="col-lg-9 col-md-9 col-sm-9">
                        <div class="notif-content">
                          ...
                          nec biinjk viverra donec
                          <span style={{color: "#f36f69"}}>utilisation</span>
                          integer id.
                        </div>
                      </div>
