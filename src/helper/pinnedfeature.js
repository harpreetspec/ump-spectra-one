...
return (
  ...
  <div className="dashboard-box">
    ...
    <div class="col-xl-4 col-lg-5 col-sm-12 col-12">
      ...
      {/* For OBB & BBB */}
      {getDataConsumptionParms && (getPinnedClicked && ((getPinnedClicked.SegmentName === "OBB" || getPinnedClicked.SegmentName === "BBB") &&
      <L2OBBDataConsumptionTable parms={getDataConsumptionParms}/>))
      }

      {segment && !getPinnedClicked && ((segment === "OBB" || segment === "BBB") ) &&
      <L2OBBDataConsumptionTable parms={defaultNetworkUsage}/>
      }
      {/* Get Help Section */}
      <GetHelp />
    </div>
