...
import PinnedfeatureAvs from '../helper/pinnedfeatureAvs';
...
export default function Dashboard() {
  ...
  const segmenttp = sessionStorage.getItem('tp');
        ...
        <div class="">
          <div class="d-flex justify-content-end">
            ...
            <div class="dashboard-main">
                      ...
                      <div class="card-box card-box-2" onClick={handleRedirectBillPage}>
                        ...
                        <div class="card-info pt-2">
                          ...
                          <div class="card-option">
                            ...
                            <div class="card-options">
                              Due <span class="span-negative">{getGetInvoiceDueAmount1}</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              {(crmRole == 'L2' && segmenttp !== "AIVIS") && <div class="dashboard-content row">
                {/* <div class="col-xl-8 col-lg-7 col-sm-12 col-12"> */}
              ...
              {(crmRole == 'L2' && segmenttp == "AIVIS") && <div class="dashboard-content row">
                ...
                {/* WISHLIST Features SECTION  */}
                <PinnedfeatureAvs allcitydrop={allcitydrop} />
