...
export default function ForgetDetailsSuccessMobile() {
                ...
                <div class="form-box-content-wrapper">
                  <div class="instructions-box">
                    ...
                    <div class="form-instruction mt-3 mb-3">
                      SMS sent to your registered mobile number. <br />
                  ...
                  <button
                    ...
                    onclick="handleLoginBtnClick(event)"
                  >
                    Proceed to Login
                  </button>
                  <div class="resend mt-4 text-end">
                    <a href="" class="text-white">Resend SMS</a>
                  </div>
                </div>
              </div>
              <div class="copyright">
