...
export default function SideBar() {
  ...
  useEffect(() => {
    ...
    switch (firstPartOfPath) {
      case "dashboard":
        setActiveItem("dashboardAvs");
        break;
      case "accountdetails":
        setActiveItem("myAccountAvs");
        break;
      ...
      default:
        ...
        setActiveItem("dashboardAvs"); // Set default to dashboard if the URL doesn't match any item
    ...
    <>
      <nav className="side-nav">
        ...
        <ul className="nav-list">
          ...
          <li className={`side-item ${activeItem === "dashboardAvs" ? "active" : ""}`}>
            <Link className="side-link" to="/dashboard">
              <div className="nav-logo">
          ...
          <li className={`side-item ${activeItem === "myAccountAvs" ? "active" : ""}`}>
