                           ...
                           <div className="col-xl-3 col-lg-3 col-sm-6 account-detail-card py-2 py-md-3 custm-tds">
                            <div className="d-flex align-items-start justify-content-start account-billing-detail-box">
                              ...
                              <div className="px-3 py-1">
                                ...
                                {!showDropdownData && isPinnedDataAvailable && pinnedData && (<div className="info-content">{pftds ? (pftds * 100) +"%" : 'NA'}</div>)}
                                {showDropdownData && (<div className="info-content">{tdsbydrop ? (tdsbydrop * 100) +"%" : 'NA'}</div>)}
                                {!showDropdownData && !isPinnedDataAvailable && !pinnedData && (<div className="info-content">{tds ? (tds * 100) +"%": 'NA'}</div>)}
                              </div>
                            </div>
                          </div>
                          {/* current balance */}
