...
export default function AccountDetails() {
  ...
  const handleTextValue = (event) => {
    // console.log("handleTextValue", (event.target.value).length)
    ...
    let delReq = selectedRangeAvs?"Data deletion request: "+selectedRangeAvs+ "\n":"";
    setTextComment(delReq + event.target.value);
  }
  ...
  const handleSubmit = async (event) => {
    ...
    selectedIssue.ComplaintDesc = textcomment
    try {      
